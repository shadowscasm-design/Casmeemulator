...
use crate::{
    ...
    system_image::{resolve_system_image, SystemImagePlan},
...
pub struct BootReport {
    ...
    pub system_image: SystemImagePlan,
}
...
impl CasmEngine {
    ...
    pub async fn boot(&self) -> Result<BootReport> {
        ...
        Ok(BootReport {
            ...
            system_image: resolve_system_image(&self.config),
        })
    }
}
...
mod tests {
    ...
    async fn esports_profile_targets_high_fps() {
        ...
        assert_eq!(report.system_image.id, "crdroid-10-android14-x86_64");
    }
}
